...
//  Graph
//
//  Created by Tali Moreshet 2022. Adopted from Ari Trachtenberg.
//
...
public:
    ...
    /* Identifies and prints, for each vertex of the input graph, the minimum label vertex that is reachable from it.
     It should print out the results in the following format:
     The lowest reachable vertex for 0 is 2
     The lowest reachable vertex for 1 is 3
     The lowest reachable vertex for 2 is 3
     The lowest reachable vertex for 3 is 4
